...
using TZTDate.IdentityWebApi.Data.User.Enums;

namespace TZTDate.IdentityWebApi.Data.User.Zodiac.Entities;

public static class ZodiacSign
{
    public static ZodiacDateType? GetZodiacSign(this Models.User user)
    {
    ...
    public static RelationshipData? CompatibilityByZodiacSign(this Models.User currentUser, Models.User userForCompare)
    {
